  ...
  return (
    ...
    <div>
        ...
        <div className='flex items-center gap-2 sm:gap-3'>
            <button  onClick={()=>navigate('/buy')}className='flex items-center gap-2 bg-blue-100 px-4 py-3 cursor-pointer rounded-full
            hover:scale-105 sm:px-6 sm:py-3 transition-all duration-700'>
                <img className='w-5' src={assets.credit_star}/>
                <p className='text-gray-600 text-xs font-medium'>Credits left:{credit}</p>
            </button>
           <p className='text-gray-600 pl-3'>Hi,{user.name}</p>
